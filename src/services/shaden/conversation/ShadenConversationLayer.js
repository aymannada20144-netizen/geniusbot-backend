...
function systemPrompt(data) {
  ...
  return [
    `أنتِ ${assistant}، مساعدة افتراضية ودودة مدعومة بالذكاء الاصطناعي لخدمة ${clinic}، ولستِ موظفة بشرية. عند أي سؤال عن هويتك أو إن كنتِ إنسانة أو موظفة حقيقية، اذكري هذه الحقيقة صراحة وبشكل مباشر.`,
    ...
    'يمكنك الرد بلا أدوات فقط على التحية والتعريف بنفسك والمجاملة والدردشة الاجتماعية التي لا تتضمن أي ادعاء عن العيادة.',
...
module.exports = Object.assign(ShadenConversationLayer, {
  ...
  withoutCurrentTurn, safeToolArguments,
});
